...
$(document).ready(function() {
	...
	$('.enviarRespuesta').on('click',function(event) {
		...
		$.ajax({
			...
			error:function()
			{
				$('.responseDanger').addClass('alert-danger').html('Error al responder el comentario.');
				$('.close').removeClass('hidden');
				$('.miniLoader').removeClass('active');
				$('.enviarRespuesta').removeClass('disabled')				
			}
	...
	$('.change-response-text').on('click', function(event) {
 	...
 	$('.remove-imagen').on('click', function(event) {
 		...
 		if (x) {
 			...
 			$.ajax({
 				url: 'http://preview.pasillo24.com/modificar/publicacion/eliminar/imagen',
 				type: 'POST',
 				dataType: 'json',
 				data: dataPost,
 				beforeSend:function()
 	...
 	$('.eliminar-categoria').on('click', function(event) {
 		...
 		dataPost = { 'id': btn.val() }
 		$.ajax({
 				url: 'http://preview.pasillo24.com/administrador/categorias/eliminar',
 				type: 'POST',
 				dataType: 'json',
 				data: dataPost,
 				beforeSend:function()
 	...
 	$('.eliminar-subcategoria').on('click', function(event) {
 		...
 		dataPost = { 'id': btn.val() }
 		$.ajax({
 				url: 'http://preview.pasillo24.com/administrador/subcategorias/eliminar',
 				type: 'POST',
 				dataType: 'json',
 				data: dataPost,
 				beforeSend:function()
 	...
 	$('.eliminar-cuenta').on('click',function(event) {
		var boton = $(this);
		$.ajax({
 			url: 'http://preview.pasillo24.com/administrador/editar-cuenta/eliminar',
 			type: 'POST',
 			dataType: 'json',
 			data: {'id': boton.val()},
 			beforeSend:function()
