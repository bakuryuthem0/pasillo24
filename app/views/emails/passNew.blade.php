  ...
  background-color: #286090;
   ...
   <body style="font-family:'Roboto','san serif';padding:2em 4em;">
      ...
      <div>
         ...
         <p class="bg-primary" style="padding:1em;">Este mensaje fue enviado por ffasil.com debido a su solicitud de {{ $title }} a continuacion se le mostrara su contraseña.</p>
          <p class="bg-primary" style="padding:1em;">{{ $pass }}</p>

         <ul>
            <li>Si usted no solicitó recuperar su contraseña en <strong>ffasil.com</strong>, contáctenos mediante nuestro portal.</li>
