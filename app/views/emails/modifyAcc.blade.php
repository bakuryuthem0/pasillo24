  ...
  background-color: #286090;
   ...
   <body style="font-family:'Roboto','san serif';padding:2em 4em;">
      ...
      <div>
         ...
         <ul>
            <li>Este mensaje le fue enviado debido a que se ha modificado una cuenta bancaria en <strong>pasillo24.com</strong>.</li>
         </ul>
	       <p class="bg-primary" style="padding:1em;">Numero de cuenta creada: {{ $num }} </p>
         <p class="bg-primary" style="padding:1em;">Modificado por: {{ $creadoPor }}</p>
         <ul>
